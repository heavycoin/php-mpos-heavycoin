...
$(document).ready(function(){
  ...
  function refreshStaticData(data) {
    ...
    $('#b-reward').html(number_format(data.getdashboarddata.data.network.reward, 0));
    $('#b-phase').html(data.getdashboarddata.data.network.phase);
    $('#m-supply').html(number_format(data.getdashboarddata.data.network.supply, 0));
    $('#m-max').html(number_format(data.getdashboarddata.data.network.mmax, 0));

    $('#b-rewardest').html(number_format(data.getdashboarddata.data.network.rewardest, 0));
    $('#b-rewardnextwhen').html(data.getdashboarddata.data.network.rewardnextwhen);
