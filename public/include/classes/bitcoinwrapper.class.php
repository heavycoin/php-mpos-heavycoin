...
class BitcoinWrapper extends BitcoinClient {
  ...
  // Get max allowed block reward vote for current phase
  public function getmaxvote() {
    try {
      return parent::getmaxvote();
    } catch (Exception $e) {
      return 0;
    }
    return 0;
  ...
  // Get current voting phase name (Mint, Limit, Sustain)
  ...
  // Get maximum posible money supply
  public function getmaxmoney() {
    try {
      return parent::getmaxmoney();
    } catch (Exception $e) {
      return "";
    }
    return "";
  ...
  // Get maximum posible money supply
  public function getnextrewardestimate() {
   try {
     return parent::getnextrewardestimate();
   } catch (Exception $e) {
     return "";
   }
   return "";
  ...
  // Get maximum posible money supply
  public function getnextrewardwhenstr() {
   try {
     return parent::getnextrewardwhenstr();
   } catch (Exception $e) {
     return "";
   }
   return "";
