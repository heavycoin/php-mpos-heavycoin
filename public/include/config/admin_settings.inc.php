...
$aSettings['acl'][] = array(
  'display' => 'Voting Statistics', 'type' => 'select',
  'options' => array( 0 => 'Private', 1 => 'Public', 2 => 'Disabled' ),
  'default' => 1,
  'name' => 'acl_voting_statistics', 'value' => $setting->getValue('acl_voting_statistics'),
  'tooltip' => 'Make the Voting Statistics page private (users only) or public.'
);
$aSettings['acl'][] = array(
